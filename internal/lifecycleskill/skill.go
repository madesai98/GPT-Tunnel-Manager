package lifecycleskill

// Content is the generic skill text shipped with GPT Tunnel Manager. Keeping a
// compiled copy makes skill export work from a standalone packaged executable;
// assets/lifecycle-skill/SKILL.md remains the human-readable source artifact.
const Content = `---
